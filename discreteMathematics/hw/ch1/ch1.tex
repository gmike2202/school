...
\begin{proof}
  ...
  Finding the difference, we get $n^2+n+n+1-n^2$. This results in $n + n + 1$ which can be written as $2n + 1$.
  Recall the definition of an odd number to be any number that can be written $2n + 1$.
\end{proof}
\begin{other}{Result}
  Therefore, through the definition of an odd number,any integer that can be written that can be written as $2n+1$, where n is an integer is even.
